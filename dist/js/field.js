...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        setInitialValue: function setInitialValue() {
            ...
            if (this.resourceId) {
                Nova.request(baseUrl + this.resourceName + '/' + this.resourceId + '/attachable/' + this.field.attribute).then(function (data) {
                    ...
                    _this.quantities = data.data.quantities || {};
                    _this.loading = false;
                });
            } else {
        ...
        checkIfSelectAllIsActive: function checkIfSelectAllIsActive() {
            ...
            this.resources.forEach(function (resource) {
                if (_this2.selected.includes(resource.value)) {
        ...
        resources: function resources() {
            ...
            if (this.preview) {
                return this.available.filter(function (resource) {
                    return _this3.selected.includes(resource.value);
                });
            }
            ...
            return this.available.filter(function (resource) {
                console.log(resource.display.toLowerCase(), _this3.search.toLowerCase());
                return resource.display.toLowerCase().includes(_this3.search.toLowerCase());
            });
        },
                  ...
                  [
                    _vm.preview
                      ? _c(
                          ...
                          {
                            staticClass:
                              "flex justify-center items-center absolute pin z-10 bg-white"
                          },
                          [
                            _c("h3", [
                              _vm._v(
                                _vm._s(_vm.__("Selected Items")) +
                                  " (" +
                    ...
                    _c(
                      ...
                      [
                        _c("fake-checkbox", {
                          ...
                          attrs: { checked: _vm.selectingAll }
                        })
                      ],
                      1
                    ),
                    ...
                    _c(
                      "div",
                      { staticClass: "flex-1 flex items-center relative" },
                      [
                        _c("input", {
                          directives: [
                            {
                          ...
                          staticClass:
                            "form-control form-input form-input-bordered w-full ml-0 m-4",
                          attrs: {
                            type: "text",
                        ...
                        _vm.search
                          ? _c(
                              ...
                              {
                                staticClass:
                                  "pin-r font-sans font-bolder absolute pr-8 cursor-pointer text-black hover:text-80",
                  ...
                  : _vm._l(_vm.resources, function(resource) {
                      return _c(
                        ...
                        [
                          ...
                          _vm._v(" "),
                          _vm._l(_vm.field.extraFields, function(extraField) {
                            return _c(
                              "div",
                              {
                              ...
                              [
                                _c(
                                  "label",
                                  {
                                    staticClass: "col-sm-3 col-form-label p-1"
                                  },
                                  [_vm._v("จำนวน: ")]
                                ),
                                _vm._v(" "),
                                    ...
                                    directives: [
                                      {
                                        name: "model",
                                        rawName: "v-model",
                                        value: _vm.quantities[resource.value],
                                        expression: "quantities[resource.value]"
                                      }
                                    ],
            ...
            [
              _vm.field.showCounts
                ? _c(
                    ...
                    {
                      staticClass:
                        "pr-2 float-left border-60 whitespace-no-wrap",
              ...
              _vm.field.showPreview
                ? _c(
                    ...
                    {
                      staticClass:
                        "flex cursor-pointer select-none float-right",
                      on: {
                        click: function($event) {
